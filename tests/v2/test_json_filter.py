...
class JsonFilterTestCase(unittest.TestCase):
    ...
    def test_set_range_time(self):
        ...
        assert (
            actual._query["jsonFilter"] == "%7B%22type%22%3A+%22range%22%2C+%22field%22%3A+%22startTime%22%2C"
    ...
    def test_set_range_view(self):
        ...
        assert (
            actual._query["jsonFilter"] == "%7B%22type%22%3A+%22range%22%2C+%22field%22%3A+%22viewCounter%22%2C"
            "+%22from%22%3A+100%2C+%22to%22%3A+1000%2C+%22include_lower%22%3A+true"
            "%2C+%22include_upper%22%3A+true%7D"
        )

    def test_not(self):
        actual = SnapshotSearchAPIV2Filter({"q": "test"}).json_filter(JsonFilterOperator.not_(self.term_view))
        assert (
            actual._query["jsonFilter"] == "%7B%22type%22%3A+%22not%22%2C+%22filter%22%3A+%7B%22type%22%3A"
    ...
    def test_or(self):
        ...
        assert (
            actual._query["jsonFilter"] == "%7B%22type%22%3A+%22or%22%2C+%22filters%22%3A+%5B%7B%22type%22%3A"
            "+%22range%22%2C+%22field%22%3A+%22viewCounter%22%2C+%22from%22%3A+100"
            "%2C+%22to%22%3A+1000%2C+%22include_lower%22%3A+true%2C"
    ...
    def test_and(self):
        ...
        assert (
            actual._query["jsonFilter"] == "%7B%22type%22%3A+%22and%22%2C+%22filters%22%3A+%5B%7B%22type%22%3A"
            "+%22range%22%2C+%22field%22%3A+%22viewCounter%22%2C+%22from%22%3A+100"
            "%2C+%22to%22%3A+1000%2C+%22include_lower%22%3A+true%2C"
            "+%22include_upper%22%3A+true%7D%2C+%7B%22type%22%3A+%22range%22%2C"
            "+%22field%22%3A+%22startTime%22%2C+%22from%22%3A+%222021-01-01T00%3A00"
    ...
    def test_nested(self):
        actual = SnapshotSearchAPIV2Filter({"q": "test"}).json_filter(
            JsonFilterOperator.or_(JsonFilterOperator.not_(self.term_view), self.term_time)
        )
        assert (
            actual._query["jsonFilter"] == "%7B%22type%22%3A+%22or%22%2C+%22filters%22%3A+%5B%7B%22type%22%3A"
